...
class OpenDotaAPI {
     ...
     getPlayerMatches(accountId, params = {}) {
          const qs = new URLSearchParams(params).toString();
          return this.fetch(
               `/players/${accountId}/matches${qs ? "?" + qs : ""}`,
          );
     }
     ...
     getPlayerHeroes(accountId, params = {}) {
          const qs = new URLSearchParams(params).toString();
          return this.fetch(
               `/players/${accountId}/heroes${qs ? "?" + qs : ""}`,
          );
     }
     ...
     getPlayerTotals(accountId, params = {}) {
          const qs = new URLSearchParams(params).toString();
          return this.fetch(
               `/players/${accountId}/totals${qs ? "?" + qs : ""}`,
          );
     }
     ...
     getPlayerCounts(accountId, params = {}) {
          const qs = new URLSearchParams(params).toString();
          return this.fetch(
               `/players/${accountId}/counts${qs ? "?" + qs : ""}`,
          );
     }
     ...
     getPlayerHistogram(accountId, field, params = {}) {
          const qs = new URLSearchParams(params).toString();
          return this.fetch(
               `/players/${accountId}/histograms/${field}${qs ? "?" + qs : ""}`,
          );
     }
     ...
     getPlayerWardmap(accountId, params = {}) {
          const qs = new URLSearchParams(params).toString();
          return this.fetch(
               `/players/${accountId}/wardmap${qs ? "?" + qs : ""}`,
          );
     }
     ...
     getPlayerWordcloud(accountId, params = {}) {
          const qs = new URLSearchParams(params).toString();
          return this.fetch(
               `/players/${accountId}/wordcloud${qs ? "?" + qs : ""}`,
          );
     }
     ...
     refreshPlayer(accountId) {
          return this.fetch(`/players/${accountId}/refresh`, {
               method: "POST",
          });
     }
